	...
	<head>
    	...
    	<style>
    		@font-face {
				...
				font-weight: 300;
				font-style: normal;
				src :local('Open Sans'),url('${za.img_url}/opensans/font.woff') format('woff'); 
			}
        	body {
            	font-family: "Open sans";
        	}
        	...
        	.zoho_logo {
            	...
            	height: 30px;
            	width: auto;
            	background: url('${za.img_url}/zoho.png') no-repeat transparent; 
        ...
        <div class="container-hidden" id="banner_container">
            ...
            <div class="box">
                ...
                <div class="btncontainer" id="btncontainer">
    	            ...
    	            <div class="btnbox"><span class="btn" onclick="clearTimeout(_time);redirect(true);"><@i18n key="IAM.CONTINUE" /></span></div>
                </div>
            </div>
        </div>
    </body>
