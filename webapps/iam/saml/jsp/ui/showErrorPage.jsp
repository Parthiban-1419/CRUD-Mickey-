...
accountsStaticURL  = useStaticServer ? com.zoho.accounts.internal.util.Util.getJSStaticURL(AccountsInternalConst.STATIC_SERVER_CONTEXT) : accountsStaticURL;
String errorMessage = (String) ActionContext.getContext().get("SAMLException"); //No I18N
...
<style>
    ...
    .errtbl {margin-top:5%;}
    .zohologo {background: transparent url('<%=imgurl%>/rebrand.gif') no-repeat -9px -199px;width: 210px;height: 29px;margin: 4px 0px 0px 6px; border: none;} <%-- NO OUTPUTENCODING --%>
...
<body>
	...
	<tr><td  valign="middle">
		...
		<div class="errmsgdiv">
			...
			<b><%=Util.getI18NMsg(request, errorMessage)%></b>
			<%-- <ul>
	...
	<tr><td  valign="middle">
<%
String supportEmailAddress = AccountsConfiguration.getConfiguration("support.emailid", "support@zohoaccounts.com"); //No I18N
%>
