        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
                        <@i18n key="IAM.TPL.MFA.NOTE"/><@i18n key="IAM.MFA.HELP.DOCUMENT.MSG" arg0="${ztpl.helplink}"/>
                    </td>
                    </tr> 
                    <tr>
                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
                       <@i18n key="IAM.TPL.MFA.NOT.OPTED.WARN.MESSAGE" arg0="${ztpl.SUPPORT_EMAIL}"/>
                    </td>
                    </tr>
                    <#else>
                    <tr>
                    <td style="font-size: 24px;line-height: 48px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
                        <b><@i18n key="IAM.MFA.DEACTIVE"/></b>
                    </td>
                    </tr>
                    <tr>
                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
                       <@i18n key="IAM.TPL.MFA.STATUS.DEACTIVATED"/>
                    </td>
                    </tr>
                    <tr>
                    <td style="padding:20px 0 20px 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
                       <@i18n key="IAM.TPL.MFA.STATUS.DEACTIVATED.RECONFIGURE"/>
                    </td>
                    </tr>
                    <tr>
                       <td>
                    ...
                    <tr>
                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
                       <@i18n key="IAM.TPL.MFA.WARN.MESSAGE" arg0="${ztpl.SUPPORT_EMAIL}"/>
                    </td>
                    </tr>
                    </#if>
                    <tr>
