	            ...
	            <td>
	                <table border="0" cellpadding="0" cellspacing="0" width="100%">
	                    <tr style="display:none;">
 	                    ...
 	                    <tr>
		                    <td style="font-size: 24px !important;line-height: 48px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
	                ...
	                <table> 
			            <tr>
			                <td style="padding:10px 0 10px 0;font-size: 12px;color:#757575;line-height: 22px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
			                    <@i18n key="IAM.ORGINVITATION.ABUSE.TEXT" args0="${ztpl.APP_DISPLAY_NAME}" args1="${ztpl.ABUSE_EMAIL}" />
			                </td>
			            </tr>       
			        </table>
	            </td>
